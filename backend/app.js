...
db.query('CREATE TABLE IF NOT EXISTS posts (`id` INT(11) NOT NULL AUTO_INCREMENT, `uid` VARCHAR(125) NOT NULL, `date` DATETIME, `text` TEXT, `imgUrl` TEXT, `likes` INT(11), PRIMARY KEY (`id`) USING BTREE) CHARACTER SET utf8;');
db.query('CREATE TABLE IF NOT EXISTS comments (`id` INT(11) NOT NULL AUTO_INCREMENT, `uid` VARCHAR(125) NOT NULL, `date` DATETIME, `text` TEXT, `postid` INT(11), PRIMARY KEY (`id`) USING BTREE) CHARACTER SET utf8;');
